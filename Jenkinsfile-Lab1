                ...
                script{
                    try{
                        withEnv(['PATH+JENKINSHOME=/u/srolo/.local/bin']) {
                            ...
                            pipenv run pip install sqlite3
                            pipenv run pip install base64
                            pipenv run pip install sys
                        ...
                        sh '''#!/bin/bash
                        mail -s "Lab 1 Test Passed" raney.jack99@gmail.com < newsapp/result.txt
                        '''
                    }
                    catch(Exception e){
                        ...
                        sh 'cat newsapp/result.txt'
                        sh '''#!/bin/bash
                        mail -s "Lab 1 Test Failed" raney.jack99@gmail.com < newsapp/result.txt
                        '''
                    }
                }
            }
